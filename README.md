...
Programador **full stack** com experiência profissional na construção aplicações de ponta a ponta com as pricipais bibliotecas e frameworks dos ecossistemas do **Java**, **C#**, **Javascript/Typescript** e **PHP**. Atualmente, estou trabalhando como desenvolvedor fullstack pleno no Tribunal de Contas do Rio Grande do Norte (TCE-RN).
